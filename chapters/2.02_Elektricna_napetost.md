...
![Premik električnega naboja v homogenem električnem polju. Čeprav se naboj v prvem primeru premakne iz potenciala 1 V na 2 V, v drugem pa iz 3 V na 4 V, je razlika potencialov v obeh primerih enaka ($\Delta V = 1\,\mathrm{V}$). Zato električno polje opravi enako delo na enako velikem naboju.](figures/02_06_homogeno_polje_napetost.png){#fig:homogeno-polje-napetost}
...
![Potenciali in napetosti v vezju diagnostičnega vprašalnika pri odprtem stikalu. Negativni priključek baterije je izbran kot referenčna točka s potencialom $0\,\mathrm{V}$. Zaporedna upora $R_1$ in $R_2$ imata napetost $4{,}5\,\mathrm{V}$, napetost na uporu $R_3$ v prekinjeni veji pa je $0\,\mathrm{V}$.](figures/02_07_potenciali_vezje.png){#fig:potenciali-vezje width=90%}
