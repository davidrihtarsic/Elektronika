...
![Homogeno električno polje med dvema vzporednima ploščama.](figures/02_04_parallel_plates.png){#fig:parallel_plates width=70%}
...
![Primerjava vpliva lege in velikosti naboja na električno potencialno energijo: $q_1$ in $q_2$ sta enako velika in različno oddaljena od plošče $-Q$, $q_1$ in $q_3$ pa sta enako oddaljena, vendar je $q_3$ večji.](figures/02_05_same_charge_different_charge.png){#fig:charge_comparison width=75%}
...
![Ekvipotencialne ploskve v homogenem električnem polju med vzporednima ploščama.](figures/02_07_equipotential.png){#fig:equipotential width=75%}
